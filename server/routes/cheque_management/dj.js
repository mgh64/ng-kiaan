...
router.post('/cheque_dj', function(req, res, next) {
  //
      ...
      validate(req.body.ids, function(err, result) {
        ...
        if (result.valid == true) {
          ...
          db.operations.find({
            ...
            _async.each(_r, function(obj, cb) {
              ...
              obj.items.forEach(function(itm) {
                req.body.ids.forEach(function(r) {
                  if (r == itm._id) {
                    itm.status = "dj";
                    itm.dj_date = mongoose.Types.ObjectId();
                    itm.bankacc_id = req.body.bankacc_id;
            ...
            //       if (r == itm._id) {
            //         itm.status = "dj";
            //         itm.dj_date = new Date();
            //         itm.bankacc_id = req.body.bankacc_id;
            //       }
            //     })
            //     obj.save(function(err, ress) {
            //       if (err) {
            //         throw err;
            //       } else {
            //         res.json({
